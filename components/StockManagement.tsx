...
const StockManagement: React.FC<StockManagementProps> = ({ products, movements, onAddMovement }) => {
    ...
    const handleAddMovement = (e: React.FormEvent) => {
        ...
        setQuantity(1);
        setMovementsPage(1); // Reset to first page on new entry
    };
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
                <div className="lg:col-span-2 bg-white rounded-lg shadow-sm ring-1 ring-neutral-200 overflow-hidden flex flex-col h-full">
                    <div className="p-4 border-b border-neutral-200 bg-neutral-50 flex flex-col sm:flex-row justify-between items-center gap-4">
                        <h3 className="text-lg font-semibold text-neutral-900">Niveaux de Stock</h3>
                        <div className="relative w-full sm:w-64">
                            ...
                            <input
                                ...
                                className="block w-full rounded-md border-neutral-300 py-1.5 pl-10 text-sm shadow-sm focus:border-emerald-500 focus:ring-emerald-500"
                            />
                        </div>
                    </div>
                        ...
                        <table className="min-w-full divide-y divide-neutral-200">
                            <thead className="bg-white sticky top-0 z-10">
                                <tr>
                                    ...
                                    <th className="px-6 py-3 text-center text-xs font-semibold text-neutral-500 uppercase">Actions</th>
                                </tr>
                            </thead>
                            <tbody className="divide-y divide-neutral-200 bg-white">
                                ...
                                {filteredProducts.length === 0 && (
                                    <tr>
                                        <td colSpan={4} className="px-6 py-8 text-center text-neutral-500">Aucun produit trouvé.</td>
                                    </tr>
                                )}
                            </tbody>
                        </table>
                                ...
                                <div key={movement.id} className="flex items-center justify-between p-3 bg-neutral-50 rounded-lg border border-neutral-100 hover:border-emerald-200 transition-colors">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="min-w-0">
                                            ...
                                            <p className="text-xs text-neutral-500">{new Date(movement.date).toLocaleDateString()} • {movement.type}</p>
                                        </div>
                                    </div>
                        ...
                        <div className="flex justify-between items-start p-6 border-b border-gray-100">
                            <div>
                                <h3 className="text-xl font-bold text-gray-900 flex items-center gap-2">
                                    <Archive className="text-emerald-600" /> Historique : {historyProduct.name}
                                </h3>
                                <p className="text-sm text-gray-500 mt-1">SKU: {historyProduct.productCode} • Stock Actuel: <span className="font-bold text-gray-900">{historyProduct.stockQuantity}</span></p>
                            </div>
                            ...
                            <table className="min-w-full divide-y divide-gray-200">
                                <thead className="bg-gray-50">
                                    <tr>
                                        ...
                                        <th className="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">Mouvement</th>
                                    </tr>
                                </thead>
